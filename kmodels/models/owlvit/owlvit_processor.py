...
from kmodels.models.owlvit.owlvit_image_processor import OwlViTImageProcessor
...
class OwlViTProcessor(BaseProcessor):
    ...
    Mirrors HF ``OwlViTProcessor``: text queries are flattened across
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.image_processor = OwlViTImageProcessor(
            size=size,
            resample=resample,
