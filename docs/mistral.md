...
These are <b>gated</b>: accept the license at <a href="https://huggingface.co/mistralai/Mistral-7B-v0.1" style="color:#1a5c8a;">mistralai/Mistral-7B-v0.1</a>, then authenticate with
