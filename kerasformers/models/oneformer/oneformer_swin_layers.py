...
class OneFormerSwinPatchEmbeddings(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerSwinPatchMerging(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerSwinSelfAttention(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerSwinAttention(layers.Layer):
    """Windowed self-attention followed by an output projection.

    Thin wrapper composing :class:`OneFormerSwinSelfAttention` with the
    ...
    def __init__(self, dim, num_heads, window_size, **kwargs):
        super().__init__(**kwargs)
        self.self_attn = OneFormerSwinSelfAttention(
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerSwinBlock(layers.Layer):
    ...
    def __init__(
        ...
        self.attention = OneFormerSwinAttention(
...
class OneFormerSwinStage(layers.Layer):
    ...
    def __init__(self, dim, depth, num_heads, window_size, downsample, **kwargs):
        ...
        if downsample:
            self.downsample = OneFormerSwinPatchMerging(dim, name="downsample")
        else:
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerSwinBackbone(layers.Layer):
    ...
    maps in the configured data format, consumed by the OneFormer pixel
    decoder.
    ...
    def __init__(
        ...
        self.patch_embeddings = OneFormerSwinPatchEmbeddings(
            embed_dim,
            data_format=self.data_format,
