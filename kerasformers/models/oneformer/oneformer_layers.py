...
class OneFormerSinePositionEmbedding(layers.Layer):
    ...
    References:
        - OneFormer: https://arxiv.org/abs/2112.01527
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerDeformableAttention(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerCrossAttention(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerSelfAttention(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerLearnedEmbedding(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class OneFormerReferencePoints(layers.Layer):
