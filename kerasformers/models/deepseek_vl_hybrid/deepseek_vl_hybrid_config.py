...
class DeepseekVLHybridTextConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.deepseek_vl_hybrid import DeepseekVLHybridTextConfig
...
class DeepseekVLHybridVisionConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.deepseek_vl_hybrid import DeepseekVLHybridVisionConfig
...
class DeepseekVLHybridHighResConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.deepseek_vl_hybrid import DeepseekVLHybridHighResConfig
