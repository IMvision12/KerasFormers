...
from .glm4_moe_lite_layers import (
...
class Glm4MoeLiteModel(SubclassedBaseModel):
    """GLM-4.7-Flash backbone (``glm4_moe_lite``): a DeepSeek-V3-style MoE decoder
    (MLA + aux-loss-free DeepSeekMoE), i.e. GLM-5 without the DSA indexer. Standalone
    (its own layers), so it can pin the router bias float32 without touching
    deepseek_v3 / kimi_k25. Otherwise numerically the DeepSeek-V3 decoder.
    ...
    Returns raw features; use :class:`Glm4MoeLiteTextGenerate` for logits / text.
    ...
    Args:
        ...
        tie_embeddings: Whether :class:`Glm4MoeLiteTextGenerate` ties the LM head.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.final_norm = Glm4MoeLiteRMSNorm(eps=norm_eps, name="final_norm")
...
@keras.saving.register_keras_serializable(package="kerasformers")
class Glm4MoeLiteTextGenerate(Glm4MoeLiteModel, BaseGeneration):
