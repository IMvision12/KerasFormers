...
from kerasformers.models.siglip.siglip_config import (
    SigLIPConfig,
    SigLIPTextConfig,
    SigLIPVisionConfig,
)
...
class Siglip2TextConfig(SigLIPTextConfig):
    ...
    ```python
    >>> from kerasformers.models.siglip2 import Siglip2TextConfig
...
class Siglip2Config(SigLIPConfig):
    ...
    ```python
    >>> from kerasformers.models.siglip2 import Siglip2Config, SigLIP2ImageClassify
