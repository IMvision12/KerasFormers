...
class DinoV3ViTConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.dino_v3 import DinoV3ViTConfig, DinoV3ViTModel
...
class DinoV3ConvNeXtConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.dino_v3 import DinoV3ConvNeXtConfig, DinoV3ConvNeXtModel
