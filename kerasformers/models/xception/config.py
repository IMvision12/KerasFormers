...
This kerasformers Xception implements the original Keras / Chollet 2017 Xception
...
XCEPTION_WEIGHT_CONFIG = {
    ...
    "xception_in1k": {
        ...
        "url": "https://github.com/IMvision12/KerasFormers/releases/download/v0.1/keras_org_xception.weights.h5",
    },
}
