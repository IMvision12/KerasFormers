...
from kerasformers.models.qwen3_next.qwen3_next_layers import (
    ...
    **interleaved** partial-rotary M-RoPE. Returns raw features; use
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # keras init via SubclassedBaseModel (see Qwen3VLModel for the same pattern).
        ...
        self.visual = Qwen3_5MoeVisionModel(
