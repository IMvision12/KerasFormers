...
class CLIPTextConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.clip import CLIPTextConfig
...
class CLIPVisionConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.clip import CLIPVisionConfig
...
class CLIPConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.clip import CLIPConfig, CLIPImageClassify
