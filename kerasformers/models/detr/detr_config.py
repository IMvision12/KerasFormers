...
class DetrConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.detr import DetrConfig, DETRDetect

    >>> # Initializing a DETR kerasformers/detr-resnet-50 style configuration
...
class DetrSegmentConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.detr import DetrSegmentConfig, DETRPanopticSegment
