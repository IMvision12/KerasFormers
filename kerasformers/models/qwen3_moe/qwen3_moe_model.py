...
from .config import QWEN3_MOE_CONFIG, QWEN3_MOE_WEIGHTS_URLS
...
class Qwen3MoeModel(SubclassedBaseModel):
    """Qwen2-MoE sparse decoder (e.g. Qwen1.5-MoE-A2.7B, Qwen2-57B-A14B).

    Qwen3 GQA (per-head QK-norm, bias-free QKV) with a Qwen3-MoE block on
    the sparse layers: a float32-softmax top-k router over ``num_experts``
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.final_norm = Qwen3MoeRMSNorm(eps=norm_eps, name="final_norm")
    ...
    def config_from_hf(cls, hf_config):
        return {
            ...
            "moe_mlp_dim": hf_config.get("moe_intermediate_size", 768),
    ...
    def transfer_from_hf(cls, keras_model, hf_state_dict):
        from .convert_qwen3_moe_hf_to_keras import transfer_qwen3_moe_weights

        transfer_qwen3_moe_weights(keras_model, hf_state_dict)
