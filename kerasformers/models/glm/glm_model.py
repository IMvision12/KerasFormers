...
class GlmModel(SubclassedBaseModel):
    ...
    HF_MODEL_TYPE = "glm"
    BASE_MODEL_CONFIG = GLM_CONFIG
    BASE_WEIGHT_CONFIG = GLM_WEIGHTS_URLS
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.final_norm = GlmRMSNorm(eps=norm_eps, name="final_norm")
