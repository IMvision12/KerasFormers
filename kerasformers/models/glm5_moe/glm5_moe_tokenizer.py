...
class Glm5MoeTokenizer(BaseTokenizer):
    """GLM-5 BPE tokenizer (``tokenizers`` backend, 154880 vocab).
    ...
    Args:
        hf_id: Hub repo to pull ``tokenizer.json`` from (e.g. ``zai-org/GLM-5.2``).
