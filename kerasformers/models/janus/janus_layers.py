...
class JanusTextRMSNorm(layers.Layer):
...
@keras.saving.register_keras_serializable(package="kerasformers")
class JanusTextAttention(layers.Layer):
    """JanusText grouped-query causal self-attention.
...
@keras.saving.register_keras_serializable(package="kerasformers")
class JanusTextDecoderLayer(layers.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.attention_norm = JanusTextRMSNorm(eps=norm_eps, name="attention_norm")
        self.attention = JanusTextAttention(
            embed_dim, num_heads, num_kv_heads, head_dim, name="attention"
        )
        self.mlp_norm = JanusTextRMSNorm(eps=norm_eps, name="mlp_norm")
        self.mlp = JanusTextMLP(embed_dim, mlp_dim, name="mlp")
...
@keras.saving.register_keras_serializable(package="kerasformers")
class JanusVisionLayer(layers.Layer):
    ...
    def __init__(self, embed_dim, mlp_dim, num_heads, norm_eps=1e-6, **kwargs):
        ...
        self.attention = JanusVisionAttention(embed_dim, num_heads, name="attention")
