...
class MetaClip2TextConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.metaclip2 import MetaClip2TextConfig
...
class MetaClip2VisionConfig(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.metaclip2 import MetaClip2VisionConfig
...
class MetaClip2Config(BaseConfig):
    ...
    ```python
    >>> from kerasformers.models.metaclip2 import MetaClip2Config, MetaClip2ImageClassify
