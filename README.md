...
- Text Encoders (text → embeddings, masked LM, classification)
    ...
    | ModernBERT | [Smarter, Better, Faster, Longer: A Modern Bidirectional Encoder for Fast, Memory Efficient, and Long Context Finetuning and Inference](https://arxiv.org/abs/2412.13663) | `transformers` |
    | DistilBERT | [DistilBERT, a distilled version of BERT: smaller, faster, cheaper and lighter](https://arxiv.org/abs/1910.01108) | `transformers` |
